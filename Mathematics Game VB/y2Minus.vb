Public Class y2Minus
    ...
    Private Sub y2Minus_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        OnlyTen()
        GenerateSum()
    End Sub
    ...
    Private Sub btnGo_Click(sender As Object, e As EventArgs) Handles btnGo.Click
        ...
        End If
    End Sub
    Private Sub y2Minus_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
