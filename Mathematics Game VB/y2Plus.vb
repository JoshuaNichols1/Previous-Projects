Public Class y2Plus
    ...
    Public Sub GenerateSum()
        ...
        lblPlus.Text = ("+")
        txtboxAnswer.Clear()
        Dim num0 = random0.Next(20, 30)
        Dim num1 = random1.Next(20, 50)
    ...
    Private Sub y2Plus_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        OnlyTen()
        GenerateSum()
    End Sub
    ...
    Private Sub btnGo_Click(sender As Object, e As EventArgs) Handles btnGo.Click
        ...
        End If
    End Sub
    Private Sub y2Plus_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
