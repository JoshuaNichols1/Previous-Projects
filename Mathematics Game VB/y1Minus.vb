Public Class y1Minus
    ...
    Public Sub GenerateSum()
        ...
        lblMinus.Text = ("-")
        txtboxAnswer.Clear()
        Dim num0 = random0.Next(1, 10)
        Dim num1 = random1.Next(0, 10)
    ...
    Private Sub y1Minus_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        OnlyTen()
        GenerateSum()
    End Sub
    ...
    Private Sub btnGo_Click(sender As Object, e As EventArgs) Handles btnGo.Click
        ...
        End If
    End Sub
    Private Sub y1Minus_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
